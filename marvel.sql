...
-- INSERT INTO movies (title, year, show_time) VALUES ('Avengers: Infinity War', 2020, '10:00');
-- SELECT * FROM movies;

-- The cinema would like to make the Iron Man movies a triple billing. Find out the show time of “Iron Man 2”
-- and set the show time of “Iron Man 3” to start two hours later.
